...
class TestCrossModelAnalyticsFixed(unittest.TestCase):
        ...
        with self.memory_store._get_connection() as conn:
            ...
            test_sessions = [
                ...
                ('job_001', 'model_a', 'completed', 
                 ...
                 100, '{"learning_rate": 0.001, "epochs": 100}', None, current_time, current_time),
                ...
                ('job_004', 'model_b', 'completed',
                 ...
                 100, '{"learning_rate": 0.0005, "epochs": 150}', None, current_time, current_time),
                ...
                ('job_006', 'model_c', 'completed',
                 ...
                 100, '{"learning_rate": 0.01, "epochs": 200}', None, current_time, current_time),
            ]
    ...
    def test_analytics_with_mock_training_history(self):
        ...
        # Patch the method
        with patch.object(self.analytics, '_get_training_history', return_value=mock_history):
    ...
    def test_model_comparison_with_mocked_data(self):
        ...
        with patch.object(self.analytics, 'analyze_model_performance', side_effect=mock_analyze_performance):
    ...
    def test_efficiency_score_calculation(self):
        ...
        zero_duration_history = [
            {'final_loss': 0.1, 'training_duration': 0}
        ]
