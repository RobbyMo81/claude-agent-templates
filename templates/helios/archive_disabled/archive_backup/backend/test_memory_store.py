...
class TestMemoryStore(unittest.TestCase):
    ...
    def test_knowledge_fragments(self):
        ...
        fragments = self.memory_store.get_knowledge_fragments(
            model_name="test_model"
        )
        ...
        self.assertEqual(high_relevance_fragments[0]['content'], "Numbers ending in 5 appear 15% more frequently")
    ...
    def test_performance_metrics(self):
        ...
        recent_metrics = self.memory_store.get_performance_metrics(
            model_name="test_model",
            hours=24  # Use 24 hours instead of 1 hour
        )
    ...
    def test_context_storage(self):
        ...
        self.assertEqual(retrieved_context['context_data']['user_preferences']['theme'], "dark")
    ...
    def test_system_events(self):
        ...
        self.assertEqual(training_events[0]['event_data']['component'], "training_manager")
    ...
    def test_concurrent_access(self):
        ...
        models = self.memory_store.list_models()
        concurrent_models = [m for m in models if m['name'].startswith('concurrent_model_')]
