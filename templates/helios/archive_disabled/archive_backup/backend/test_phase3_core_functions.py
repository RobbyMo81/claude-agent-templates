    ...
    try:
        ...
        try:
            ...
            if result:
                ...
                log_test_result('memory_store', 'save_model_metadata()', False, "Function returned False")
        except Exception as e:
        ...
        try:
            ...
            if retrieved and retrieved['name'] == 'test_model_v1':
                ...
                log_test_result('memory_store', 'get_model_metadata()', False, "Retrieved data mismatch")
        except Exception as e:
        ...
        try:
            ...
            if isinstance(models, list) and len(models) > 0:
                ...
                log_test_result('memory_store', 'list_models()', False, f"Expected list with data, got {type(models)} with {len(models) if hasattr(models, '__len__') else 0} items")
        except Exception as e:
        ...
        try:
            ...
            if result:
                ...
                log_test_result('memory_store', 'save_prediction()', False, "Function returned False")
        except Exception as e:
        ...
        log_test_result('memory_store', 'Import', False, f"Could not import MemoryStore: {e}")
    except Exception as e:
...
def test_metacognitive_engine():
    ...
    try:
        ...
        try:
            ...
            required_fields = ['confidence_score', 'predicted_performance', 'uncertainty_estimate', 
                             'knowledge_gaps', 'recommended_strategy', 'assessment_timestamp']
            
            missing_fields = [field for field in required_fields if not hasattr(assessment, field)]
            
            if not missing_fields:
                log_test_result('metacognitive_engine', 'assess_current_state()', True)
            else:
                log_test_result('metacognitive_engine', 'assess_current_state()', False, 
                              f"Missing fields: {missing_fields}")
                
        except Exception as e:
            log_test_result('metacognitive_engine', 'assess_current_state()', False, str(e))
        ...
        try:
            ...
            if isinstance(patterns, list):
                log_test_result('metacognitive_engine', 'analyze_performance_patterns()', True)
            else:
                log_test_result('metacognitive_engine', 'analyze_performance_patterns()', False, 
                              f"Expected list, got {type(patterns)}")
        except Exception as e:
            log_test_result('metacognitive_engine', 'analyze_performance_patterns()', False, str(e))
        ...
        try:
            ...
            recommendations = metacog_engine.get_learning_recommendations('test_model', mock_assessment)
            
            if isinstance(recommendations, dict):
                log_test_result('metacognitive_engine', 'get_learning_recommendations()', True)
            else:
                log_test_result('metacognitive_engine', 'get_learning_recommendations()', False, 
                              f"Expected dict, got {type(recommendations)}")
        except Exception as e:
            log_test_result('metacognitive_engine', 'get_learning_recommendations()', False, str(e))
        ...
        log_test_result('metacognitive_engine', 'Import', False, f"Could not import components: {e}")
    except Exception as e:
        log_test_result('metacognitive_engine', 'General', False, f"Unexpected error: {e}")
    ...
    try:
        ...
        try:
            ...
            if result:
                ...
                log_test_result('decision_engine', 'add_goal()', False, "Function returned False")
        except Exception as e:
        ...
        try:
            ...
            if isinstance(decisions, list):
                ...
                log_test_result('decision_engine', 'make_autonomous_decision()', False, 
                              f"Expected list, got {type(decisions)}")
        except Exception as e:
            log_test_result('decision_engine', 'make_autonomous_decision()', False, str(e))
        ...
        try:
            ...
            if isinstance(status, dict):
                ...
                log_test_result('decision_engine', 'get_system_status()', False, 
        ...
        try:
            ...
            if isinstance(goal_status, dict):
                ...
                log_test_result('decision_engine', 'get_goal_status()', False, 
        ...
        try:
            ...
            log_test_result('decision_engine', 'autonomous_mode_control()', False, str(e))
        ...
        log_test_result('decision_engine', 'Import', False, f"Could not import components: {e}")
    except Exception as e:
...
def print_test_summary():
    ...
    for component, results in test_results.items():
        ...
        status_icon = "" if failed == 0 else "" if passed > failed else ""
        logger.info(f"{status_icon} {component.upper()}: {passed} passed, {failed} failed")
    ...
    if total_failed == 0:
        ...
        logger.info("  MOSTLY FUNCTIONAL: Some issues detected but core functionality works.")
    else:
